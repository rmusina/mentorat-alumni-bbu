...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('messages_message', (
            ...
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_messages', blank=True, null=True, to=orm['auth.User'])),
            ('parent_msg', self.gf('django.db.models.fields.related.ForeignKey')(related_name='next_messages', blank=True, null=True, to=orm['messages.Message'])),
    ...
    models = {
        ...
        'messages.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_msg': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'next_messages'", 'blank': 'True', 'null': 'True', 'to': "orm['messages.Message']"}),
            'read_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'received_messages'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
