...
DATABASE_HOST = 'localhost'             # Set to edmpty string for localhost. Not used with sqlite3.
...
STATICFILES_DIRS = (
    ('mentorat', os.path.join(PROJECT_ROOT, 'media')),
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "mentorat.context_processors.combined_inbox_count",
)
